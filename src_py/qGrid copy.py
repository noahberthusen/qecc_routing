...
class Grid:
    ...
    def find_chain(self, grid, qSite1, qSite2):
        ...
        if not (grid[qSite1[0]][qSite1[1]] and 
            grid[qSite2[0]][qSite2[1]]):
            return []
    ...
    def greedy_route_set(self, gens):
        ...
        for _ in range(len(gens) + 1):
            ...
            for gen in self.generators:
                ...
                # print(res, gen.dest, gen.qbts_to_route, np.count_nonzero(self.dests))
                print(gen.dest, len(gen.routed), gen.qbts_to_route)
                # self.print_grid()
